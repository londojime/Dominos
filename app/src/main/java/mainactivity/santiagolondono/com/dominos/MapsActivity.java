        ...
        LocationListener
{
    ...
    private void handleNewLocation(Location location) {
        ...
        MarkerOptions options = new MarkerOptions()
                .position(latLng)
                .title(getResources().getString(R.string.actual));
...
////////////////////////////////////////////////////////
        ...
        //double currentLatitude = 6.502238;
        //double currentLongitude = -75.744021;
        ...
        MarkerOptions opciones = new MarkerOptions()
                .position(latLng2)
                .title(nomb);
        mMap.addMarker(opciones);
         mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng2,12));
